...
/////////////////////////////////////////////////////////////////////////
      global.myLog(ctx, `
        packages/opencode/src/server/routes/instance/httpapi/handlers/session.ts 文件
        prompt 函数
        <<httpapi-handler-session文件>>`)
/////////////////////////////////////////////////////////////////////////
      yield* requireSession(ctx.params.sessionID)
    ...
    /***
     * opencode serve 起后端服务, 会走promptAsync方法！
     * ***/
    ...
    return handlers
      ...
      .handle("prompt", prompt) // tui 输入后回车的hander
      .handle("promptAsync", promptAsync)// 浏览器 输入后回车的hander
